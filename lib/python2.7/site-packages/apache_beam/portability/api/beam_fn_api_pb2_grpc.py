...
class BeamFnExternalWorkerPoolStub(object):
  ...
  def __init__(self, channel):
    ...
    Args:
      channel: A grpc.Channel.
    """
    self.NotifyRunnerAvailable = channel.unary_unary(
        '/org.apache.beam.model.fn_execution.v1.BeamFnExternalWorkerPool/NotifyRunnerAvailable',
        request_serializer=beam__fn__api__pb2.NotifyRunnerAvailableRequest.SerializeToString,
        response_deserializer=beam__fn__api__pb2.NotifyRunnerAvailableResponse.FromString,
        )
...
class BeamFnExternalWorkerPoolServicer(object):
  ...
  def NotifyRunnerAvailable(self, request, context):
    # missing associated documentation comment in .proto file
    pass
    context.set_code(grpc.StatusCode.UNIMPLEMENTED)
    context.set_details('Method not implemented!')
...
def add_BeamFnExternalWorkerPoolServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'NotifyRunnerAvailable': grpc.unary_unary_rpc_method_handler(
          servicer.NotifyRunnerAvailable,
          request_deserializer=beam__fn__api__pb2.NotifyRunnerAvailableRequest.FromString,
          response_serializer=beam__fn__api__pb2.NotifyRunnerAvailableResponse.SerializeToString,
      ),
  }
  generic_handler = grpc.method_handlers_generic_handler(
